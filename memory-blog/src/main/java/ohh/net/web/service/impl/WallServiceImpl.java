...
import ohh.net.web.mapper.WallCateMapper;
import ohh.net.web.mapper.WallMapper;
...
public class WallServiceImpl extends ServiceImpl<WallMapper, Wall> implements WallService {
    ...
    public List<Wall> list(WallFilterVo filterVo) {
        QueryWrapper<Wall> queryWrapper = ohhUtils.queryWrapperFilter(filterVo, "content");
